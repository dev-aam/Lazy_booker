...
Set `SERPAPI_KEY` in `.env` for live internet hotel data. Without it, the app falls back to a richer demo Indian hotel dataset (multiple cards per search) so the UI still works end-to-end.
